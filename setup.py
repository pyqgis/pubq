...
setup(
    ...
    download_url='https://github.com/pubq/%s/archive/v%s.zip' % (NAME, about['__version__']),
    project_urls={
        "Bug Tracker": "https://github.com/pubq/%s/issues" % NAME,
        "Documentation": "https://readthedocs.org/projects/%s/" % NAME,
        "Source Code": "https://github.com/pubq/%s" % NAME,
    },
    classifiers=[
        # Trove classifiers
